...
export const TopicsBreadCrumbs = {
  ...
  ARTS: ({ label }) => (
    <BreadCrumb color={TopicsColors["ARTS"]}>{label}</BreadCrumb>
  ),
  CURRENT_AFFAIRS: ({ label }) => (
    <BreadCrumb color={TopicsColors["CURRENT_AFFAIRS"]}>{label}</BreadCrumb>
  ),
  SPORTS: ({ label }) => (
    <BreadCrumb color={TopicsColors["SPORTS"]}>{label}</BreadCrumb>
  ),
};
